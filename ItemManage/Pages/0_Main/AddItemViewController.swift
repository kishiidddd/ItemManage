...
//    
//    
//    // MARK: - Setup ViewModel Observers (使用 Combine)
...
//            
//            // 监听保存成功
//            // 由于 ViewModel 中 saveItem 使用 completion，我们需要另外的方式
//            // 可以在 ViewModel 中添加一个 @Published 属性来跟踪保存状态
//            
//            // 监听加载状态
//            viewModel.$isLoading
//                .receive(on: DispatchQueue.main)
...
//            // 这个方法现在主要通过 bindings 自动更新，但可以保留用于手动刷新
...
//                self?.unitField.setValue(unit.name)
//            })
//        }
//        
//        alert.addAction(UIAlertAction(title: "取消", style: .cancel))
...
//                self?.productionDateField.setDate(selectedDate)
//            } else {
//                self?.viewModel.expiryDate = selectedDate
//                self?.expiryDateField.setDate(selectedDate)
//            }
//        })
//        
//        alert.addAction(UIAlertAction(title: "取消", style: .cancel))
...
//            self?.reminderRuleField.setValue("不提醒")
...
//                self?.reminderRuleField.setValue(rule.name)
//                
...
//                self?.reminderDaysField.setValue("提前\(day)天")
//            })
//        }
//        
//        alert.addAction(UIAlertAction(title: "取消", style: .cancel))
