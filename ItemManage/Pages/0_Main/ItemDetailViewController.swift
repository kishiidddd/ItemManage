...
//            self.cardHeightConstraint = make.height.equalTo(500).constraint // 默认高度
//        }
//        
//        // 卡片内部滚动视图
...
//            make.top.equalTo(cardContainer.snp.bottom).offset(20)
...
//            if parent.categoryId == "location" {
//                locationPath.insert(parent.name, at: 0)
//            }
//            currentItem = parent
//        }
//        
