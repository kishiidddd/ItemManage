...
class LoginViewController: UIViewController {
    ...
    private lazy var registerButton: UIButton = {
        let button = UIButton(type: .system)
        let attributedTitle = NSMutableAttributedString(string: "还没有账号？ ", attributes: [
            .font: UIFont.systemFont(ofSize: 14),
            .foregroundColor: UIColor.gray
        ])
        attributedTitle.append(NSAttributedString(string: "立即注册", attributes: [
    ...
    private func setupConstraints() {
        ...
        accountField.snp.makeConstraints { make in
            make.top.equalTo(cardView).offset(60)
            ...
            DispatchQueue.main.async {
                ...
                case .success(let json):
                    guard let auth = self.parseAuthPayload(json),
                        ...
                        self.showAlert(message: "登录响应格式错误")
                        return
                    }
